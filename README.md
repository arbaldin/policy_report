This script consult an OXIDIZED url for a given list of devices and creates a csv file with the ports that have a policy-map configured. Tested with Cisco switches and Extreme CER.
